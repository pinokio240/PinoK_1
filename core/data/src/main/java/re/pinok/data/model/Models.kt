...
// Task 22 (2026-09-03): UserProfile перенесён в :core:data
// (core/data/src/main/java/re/pinok/data/model/UserProfile.kt), пакет сохранён.
// Причина: фасады CallsApi (:feature:calls, Task 20/21) используют его в
// сигнатурах — цикл :app -> :feature:calls -> :app запрещён Gradle.
